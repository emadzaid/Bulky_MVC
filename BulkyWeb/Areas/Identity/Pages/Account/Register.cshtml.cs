...
namespace BulkyWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new()
            {
                RoleList = _roleManager.Roles.Select(role => role.Name).Select(i => new SelectListItem {Text = i, Value = i}),
                CompanyList = _unitOfWork.Company.GetAll().Select(u => new SelectListItem {Text = u.Name, Value = u.Id.ToString()})
            };
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        _userManager.AddToRoleAsync(user, SD.Role_Customer).GetAwaiter().GetResult(); // Default to customer
                    }
